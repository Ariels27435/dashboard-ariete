...
echo // CORS simple
echo app.use(cors({
echo   origin: ['http://localhost:5173', 'https://dashboard-ariete.vercel.app'],
echo   credentials: true
echo }));
echo.
echo app.use(express.json());
echo.
echo // Endpoints simples
...
git commit -m "Backend simple sin MongoDB para funcionar inmediatamente"
